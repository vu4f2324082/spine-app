...
<div class="min-h-screen bg-bg flex">
  ...
  <div class="hidden lg:flex flex-col justify-between w-2/5 bg-primary px-12 py-10">
    <a href="/" class="flex items-center gap-2.5">
      <div class="w-9 h-9 bg-white/20 rounded-xl flex items-center justify-center text-white font-bold">S</div>
  ...
  <div class="flex-1 flex flex-col items-center justify-center px-6 py-12">
    <div class="w-full max-w-md">
      ...
      <!-- Google Sign In -->
      <button onclick={handleGoogle} disabled={loading} class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-border rounded-xl text-sm font-medium hover:bg-surface transition-colors disabled:opacity-50 mb-6">
